...
@interface NSHTTPURLResponse (SWIFT_EXTENSION(PushServerAPI))
@end
...
@interface NSMutableData (SWIFT_EXTENSION(PushServerAPI))
@end
...
/// \code
/// [[PushServerAPI default] getMessageHistory:@"sadfasd" maxCount:25 complete:^(InOutMessageHistoryResponse * _Nullable response) {
///
/// }];
///
///
...
/// \param complete callback, завершения.
///
- (void)getMessageHistory:(NSString * _Nonnull)clientId maxCount:(NSInteger)maxCount complete:(void (^ _Nullable)(InOutMessageHistoryResponse * _Nullable))complete;
/// Метод получения следующих сообщений из истории
/// \code
/// [[PushServerAPI default] getNextMessageHistory:@"sadfasd" maxCount:25 complete:^(InOutMessageHistoryResponse * _Nullable response) {
///
/// }];
///
///
...
/// \param complete callback, завершения.
///
- (void)getNextMessageHistory:(NSString * _Nonnull)clientId maxCount:(NSInteger)maxCount complete:(void (^ _Nullable)(InOutMessageHistoryResponse * _Nullable))complete;
@end
...
@interface PushServerAPI (SWIFT_EXTENSION(PushServerAPI))
/// UserSecurityHash из PushAPI 1.0
@property (nonatomic, copy) NSString * _Nullable userSecurityHash;
...
- (NSDictionary<NSString *, id> * _Nullable)sendSyncRequest:(ProtoRequest * _Nonnull)mfmrequest error:(NSError * _Nullable * _Nullable)error;
- (NSURLSessionTask * _Nullable)sendRequest:(ProtoRequest * _Nonnull)mfmrequest error:(NSError * _Nullable * _Nullable)error responseBlock:(void (^ _Nullable)(NSDictionary<NSString *, id> * _Nonnull))responseBlock failureBlock:(void (^ _Nullable)(void))failureBlock;
...
@interface UIDevice (SWIFT_EXTENSION(PushServerAPI))
@end
