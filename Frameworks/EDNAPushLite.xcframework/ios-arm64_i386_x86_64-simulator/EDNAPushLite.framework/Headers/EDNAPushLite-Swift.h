...
#ifndef EDNAPUSHLITE_SWIFT_H
#define EDNAPUSHLITE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EDNAPushLite",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSString;
@protocol EDNAPushLiteDelegate;
@class NSNumber;
@protocol EDNAPushLiteAppDelegateProxy;
@protocol UNUserNotificationCenterDelegate;
@class EDNASendMessageResponse;

SWIFT_CLASS("_TtC12EDNAPushLite12EDNAPushLite")
@interface EDNAPushLite : NSObject
+ (NSString * _Nonnull)libVersion SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithDelegate:(id <EDNAPushLiteDelegate> _Nonnull)delegate OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly, strong) id <EDNAPushLiteAppDelegateProxy> _Nonnull appDelegate;
...
- (void)sendMessage:(NSString * _Nonnull)message isSystem:(BOOL)isSystem onComplete:(void (^ _Nullable)(EDNASendMessageResponse * _Nonnull))onComplete onError:(void (^ _Nullable)(NSString * _Nonnull))onError;
...
SWIFT_PROTOCOL("_TtP12EDNAPushLite28EDNAPushLiteAppDelegateProxy_")
@protocol EDNAPushLiteAppDelegateProxy
...
SWIFT_PROTOCOL("_TtP12EDNAPushLite20EDNAPushLiteDelegate_")
@protocol EDNAPushLiteDelegate
- (BOOL)isProductionWithPushApi:(EDNAPushLite * _Nonnull)pushApi SWIFT_WARN_UNUSED_RESULT;
@optional
- (id <PushServerApiConfigDataSource> _Nonnull)configWithPushApi:(EDNAPushLite * _Nonnull)pushApi SWIFT_WARN_UNUSED_RESULT;
- (void)onErrorWithPushApi:(EDNAPushLite * _Nonnull)pushApi error:(NSString * _Nonnull)error;
- (void)onDeviceAddressChangedWithPushApi:(EDNAPushLite * _Nonnull)pushApi deviceAddress:(NSString * _Nonnull)deviceAddress;
- (void)onPushMessagesReceivedWithPushApi:(EDNAPushLite * _Nonnull)pushApi messages:(NSArray<PushNotificationMessage *> * _Nonnull)messages;
@end


SWIFT_CLASS("_TtC12EDNAPushLite23EDNASendMessageResponse")
@interface EDNASendMessageResponse : NSObject
...
SWIFT_CLASS("_TtC12EDNAPushLite23PushNotificationMessage")
...
SWIFT_CLASS("_TtC12EDNAPushLite13PushServerAPI")
...
+ (void)setPUSH_API_LOG_ENABLE:(BOOL)value;
...
@interface PushServerAPI (SWIFT_EXTENSION(EDNAPushLite))
...
SWIFT_PROTOCOL("_TtP12EDNAPushLite21PushServerAPIDelegate_")
@protocol PushServerAPIDelegate
@optional
...
SWIFT_PROTOCOL("_TtP12EDNAPushLite23PushServerAPINEDelegate_")
...
SWIFT_CLASS("_TtC12EDNAPushLite21PushServerAPIResponse")
...
SWIFT_PROTOCOL("_TtP12EDNAPushLite29PushServerApiConfigDataSource_")
@protocol PushServerApiConfigDataSource
...
SWIFT_CLASS("_TtC12EDNAPushLite19PushServerApiConfig")
...
SWIFT_CLASS("_TtC12EDNAPushLite19SendMessageResponse")
